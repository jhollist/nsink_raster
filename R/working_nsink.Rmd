...
```{r}
land_types <- raster::extract(niantic_types, fp_ends[1,], along = TRUE)
not_land_types <- raster::extract(niantic_types, fp_flowlines, along = TRUE)
fp_types <- unlist(c(land_types, not_land_types))
...
### Example output #3 - landcover summary table - Along a 100 m buffer
