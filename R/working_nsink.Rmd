...
# still gets all streams
# need to use graphs
# maybe some ideas in
#  http://rstudio-pubs-static.s3.amazonaws.com/10396_0359e6e40fd64f1c95044451bd1dfb1c.html
#  https://geocompr.robinlovelace.net/transport.html#route-networks
...
fp_flowlines <- get_flow_lines(fp_ends, niantic_streams)
```

6. Combine together in combo flowpath

```{r}
combo_flow_path <- st_union(fp_ends[1,],fp_flowlines)
```
