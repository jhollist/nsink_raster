...
niantic_lake_flow_path_removal <- niantic_streams %>%
  left_join(nhd_vaa, by = c("stream_comid" = "stream_comid")) %>%
  left_join(nhd_lakemorpho, by = c("wbareacomi" = "lake_comid")) %>%
  ...
  select(stream_comid, wbareacomi, removal, lake_residence_time_yrs)
