...
hydric_type_val[hydric_type_val == 0] <- NA #because streams burned in
...
niantic_types <- merge(hydric_type,
                       lake_type)
niantic_types <- mask(niantic_types, niantic_huc)
niantic_types[is.na(niantic_types)] <- 0
# re-scale back to 30 m
niantic_types <- projectRaster(niantic_types, empty_raster_30, method = "ngb")
...
niantic_fp_removal <- raster::extract(niantic_n_removal, niantic_fp,along = TRUE)
...
fp_types_max_filter <- zoo::rollmax(fp_types, 3) #This doesn't necessarily make sense...
